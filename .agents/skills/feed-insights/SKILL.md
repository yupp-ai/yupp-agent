...
allowed-tools: mcp__harness__query_yuppdb, mcp__agcouch-mcp-server-staging__query_yuppdb, mcp__harness__search_gcp_logs, mcp__agcouch-mcp-server-staging__search_gcp_logs
---
...
- **production**: `mcp__harness__query_yuppdb` and `mcp__harness__search_gcp_logs`
