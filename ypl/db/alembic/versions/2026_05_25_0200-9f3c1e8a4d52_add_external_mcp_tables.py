...
down_revision: str | None = "a3f1c4d5e6b7"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["user_id"], ["users.user_id"], name=op.f("fk_mcp_grant_events_user_id_users")),
        sa.ForeignKeyConstraint(
            ["mcp_server_id"],
            ["mcp_servers.mcp_server_id"],
    ...
    op.create_index(op.f("ix_mcp_grant_events_mcp_server_id"), "mcp_grant_events", ["mcp_server_id"], unique=False)
