...
class Settings(BaseSettings):
    ...
    SLACK_ABUSE_ALERT_APP_BOT_TOKEN: str = os.getenv("SLACK_ABUSE_ALERT_APP_BOT_TOKEN", "")
    SLACK_INTERESTING_TURNS_APP_BOT_TOKEN: str = ""
    SLACK_INTERESTING_TURNS_SIGNING_SECRET: str = ""
