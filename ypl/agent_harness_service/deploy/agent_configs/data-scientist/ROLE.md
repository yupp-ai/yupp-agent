...
```
ToolSearch(query='select:mcp__yuppster-mcp-server__query_yuppdb,mcp__yuppster-mcp-server__search_agent_memory,mcp__yuppster-mcp-server__read_slack_thread,mcp__harness__send_slack_message')
```
