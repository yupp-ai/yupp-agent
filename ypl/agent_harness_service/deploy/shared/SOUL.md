...
```
ToolSearch(query="select:mcp__agcouch-mcp-server__query_yuppdb,mcp__agcouch-mcp-server__query_agentdb,mcp__agcouch-mcp-server__search_gcp_logs,mcp__harness__send_slack_message")
```
